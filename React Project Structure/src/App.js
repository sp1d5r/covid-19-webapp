...
class App extends Component {
    ...
    render() {
        ...
        if (window.innerWidth < 500){
            return (
                <div className="App" style={{backgroundColor: "rgba(0, 0, 0, 0.80)", color: "#d4d4d4", height: "100%", width: window.innerWidth}}>
                    ...
                    <div style={{height: window.innerHeight/2}}>
                        ...
                        <br/>
                        <p>
                            -- This site was intended to be used on desktop --
                        </p>
                        ...
                        <br/>
                        <br/>
                        <p style={{textDecoration: 'underline', fontWeight: "bold"}}>Stay home, stay safe.</p>
                    </div>
